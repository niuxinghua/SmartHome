...
- (void)startUSDK{
    ...
    [DeviceService startUSDK:^(BOOL success) {
        weakSelf.isUSDKStartSuccess = success;
    }];
}
- (void)setUpWindow{
...
- (NSURL *)applicationDocumentsDirectory {
    // The directory the application uses to store the Core Data store file. This code uses a directory named "orig.yinqixing.app.SmartHome" in the application's documents directory.
